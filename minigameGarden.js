    ...
    M.soils = {
      ...
      pebbles: {
        ...
        effsStr:
          ...
          " <b>-90%</b></div>",
        q: loc(
          "Dry soil made of small crumbs tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much."
        ),
      },
      woodchips: {
        ...
        effsStr:
          ...
          " <b>-90%</b></div>",
        q: loc(
          "Soil made of bits and pieces of chocolate and flour. Helpful for young sprouts to develop, not so much for mature plants."
        ),
      },
      oatmeal: {
        name: loc("Oatmeal"),
        ...
        effsStr:
          ...
          loc(
            "tick every %1",
            "<b>" + Game.sayTime(1 * 60 * Game.fps) + "</b>"
          ) +
          '</div><div class="green">&bull; ' +
          loc("passive plant effects") +
          ' <b>x10</b></div><div class="green">&bull; ' +
          loc("plants spread and mutate <b>%1 times more</b>", 5) +
          '</div><div class="green">&bull; ' +
          loc("weed growth") +
          " <b>0%</b></div>",
        q: loc(
          "Full of raisins. Plants ticks are 1 minute, are 10x efficient, auto harvest at lifecycle end, 5x mutation rate, and no weeds."
        ),
      },
    };
    M.soilsById = [];
